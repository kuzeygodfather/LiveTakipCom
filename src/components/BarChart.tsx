  ...
  if (data.length === 0) {
    return (
      <div className="w-full">
        ...
        <div className="flex flex-col items-center justify-center py-12 px-4 bg-white/5 rounded-lg border-2 border-dashed border-white/20">
          <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mb-4">
            <svg className="w-8 h-8 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
          </div>
          <h3 className="text-lg font-semibold text-white mb-2">Henüz Şikayet Verisi Yok</h3>
          ...
          <div className="flex items-center gap-2 text-xs text-slate-400 bg-blue-500/10 border border-blue-500/20 px-3 py-2 rounded-lg">
          ...
          return (
            <div key={index} className="group">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-sm font-bold text-white ml-2">{item.value}</span>
              </div>
